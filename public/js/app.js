...
window.quickOrder = {
    ...
    setPlaces: function setPlaces(place) {
        var self = this;
    ...
    setCenterMap: function setCenterMap(coordinates) {
    ...
    setNeighborhood: function setNeighborhood(neighborhood) {
        var self = this;
        if (neighborhood) {
            var found = false;
            ...
            if (!found) {
                ...
                $.ajax({
                    ...
                    data: neighborhood,
                    success: function success(neighborhood) {
    ...
    getAddressComponentsValues: function getAddressComponentsValues(components, type) {
        var content = '';
    ...
    setOrderProductListItem: function setOrderProductListItem(quantity, id, name, value) {
    ...
    listStates: function listStates(activeId) {
        var self = this;
    ...
    listCities: function listCities(stateId, activeId) {
        var self = this;
    ...
    listNeighborhoods: function listNeighborhoods(cityId, activeId) {
        var self = this;
        ...
        if (cityId) {
            $.ajax({
                ...
                success: function success(neighborhoods) {
    ...
    onChangeCity: function onChangeCity() {
        var self = this;
    ...
    clearOrderProducts: function clearOrderProducts() {
        var self = this;
    ...
    getOrderProducts: function getOrderProducts() {
        var self = this;
        var products = [];
        ...
        $('[name=phone_primary]').blur(function () {
            ...
            if (Inputmask.isValid(phone_primary.value, { mask: "(99) 9 9999-999[9]" })) {
                $.ajax({
                    ...
                    success: function success(customer) {
    ...
    onCheckEnter: function onCheckEnter() {
